...
// Titles below are kept in sync with hearingTypesData (rendered in the HearingTypes
// section, id="hearing-types") — clicking scrolls straight to that section.
export const FOOTER_HEARING_AIDS_LINKS = [
  { label: "Behind the Ear (BTE)", href: "#hearing-types" },
  { label: "Receiver in the Canal (RIC)", href: "#hearing-types" },
  { label: "Completely in the Canal (CIC)", href: "#hearing-types" },
  { label: "Invisible in the Canal (IIC)", href: "#hearing-types" },
  { label: "Rechargeable Hearing Aid", href: "#hearing-types" },
  { label: "In the Canal (ITC)", href: "#hearing-types" },
];

export const FOOTER_HEARING_LOSS_LINKS = [
  { label: "About Hearing Loss", href: "#" },
  { label: "Types of Hearing Loss", href: "#" },
  { label: "Hearing Loss Signs & Symptoms", href: "#" },
  { label: "Children with Hearing Loss", href: "#" },
  { label: "Tinnitus Relief", href: "#" },
  { label: "Tinnitus Causes", href: "#" },
];
